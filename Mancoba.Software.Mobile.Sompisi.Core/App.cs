...
namespace Mancoba.Sompisi.Core
{
	public class App : MvxApplication
	{
		...
		{
			Mapper.CreateMap<ModelInstaller, InstallerItemViewModel>()
                ...
                .ForMember(dest => dest.WebAddress, opt => opt.MapFrom(src => src.WebAddress))
               .ForMember(dest => dest.Address, opt => opt.MapFrom(src => src.Address));

            Mapper.CreateMap<ModelProvider, ProviderItemViewModel>()
				.ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
				.ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
				.ForMember(dest => dest.ContactPerson, opt => opt.MapFrom(src => src.ContactPerson))
				.ForMember(dest => dest.EmailAddress, opt => opt.MapFrom(src => src.EmailAddress))
		    ...
		    Mapper.CreateMap<ModelProduct, ProductItemViewModel>()
		        .ForMember(dest => dest.Id, opt => opt.MapFrom(src => src.Id))
		        .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
		        .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description))
		        .ForMember(dest => dest.Price, opt => opt.MapFrom(src => string.Format("{0:C}", src.Price)));
