...
namespace Mancoba.Sompisi.Droid.Classes.Adapters
{
    ...
    public class ProviderListCustomAdapter : MvxAdapter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderListCustomAdapter"/> class.
        /// </summary>
        /// <param name="context">The context.</param>
        /// <param name="bindingContext">The binding context.</param>
        /// <param name="view">The view.</param>
        public ProviderListCustomAdapter(Context context, IMvxAndroidBindingContext bindingContext, ProviderListView view)
