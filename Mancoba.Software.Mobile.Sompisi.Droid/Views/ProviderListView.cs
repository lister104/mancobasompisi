...
namespace Mancoba.Sompisi.Droid.Views
{
	...
	[Register ("mancoba.sompisi.droid.views.ProviderListView")]
	public class ProviderListView : MvxFragment, View.IOnClickListener
	{
		...
		private View _view;
		ProviderListCustomAdapter _adapter;	
		...
		protected View CreateView(int layoutId)
		{
			...
			_adapter = new ProviderListCustomAdapter(this.Activity, (IMvxAndroidBindingContext)BindingContext, this);
			...
			var bindingSet = this.CreateBindingSet<ProviderListView, ProviderListViewModel>();
		...
		private ProviderListViewModel _viewModel;
		public new ProviderListViewModel ViewModel {
			get { return _viewModel ?? (_viewModel = base.ViewModel as ProviderListViewModel); }
		}
