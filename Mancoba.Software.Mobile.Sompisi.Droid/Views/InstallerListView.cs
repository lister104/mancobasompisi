...
namespace Mancoba.Sompisi.Droid.Views
{
	...
	[Register ("mancoba.sompisi.droid.views.InstallerListView")]
	public class InstallerListView : MvxFragment, View.IOnClickListener
	{

		public InstallerListView()
		{
			RetainInstance = true;
		...
		private View _view;
		InstallerListCustomAdapter _adapter;
		...
		protected View CreateView(int layoutId)
		{
			...
			_adapter = new InstallerListCustomAdapter(this.Activity, (IMvxAndroidBindingContext)BindingContext, this);
			...
			var bindingSet = this.CreateBindingSet<InstallerListView, InstallerListViewModel>();
		...
		public override View OnCreateView (LayoutInflater inflater, ViewGroup container, Android.OS.Bundle savedInstanceState)
		{
			...
			return CreateView (Resource.Layout.installerlistview);
		...
		private InstallerListViewModel _viewModel;
		public new InstallerListViewModel ViewModel {
			get { return _viewModel ?? (_viewModel = base.ViewModel as InstallerListViewModel); }
		}
