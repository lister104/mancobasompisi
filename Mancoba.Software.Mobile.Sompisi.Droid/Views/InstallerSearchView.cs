...
namespace Mancoba.Sompisi.Droid.Views
{
	...
	[Register("mancoba.sompisi.droid.views.InstallerSearchView")]
	public class InstallerSearchView : MvxFragment
	{
		private InstallerSearchViewModel _viewModel;
		private IMenuItem _editItem;	
		private View _view;
		

		public InstallerSearchView()
		{
			RetainInstance = true;
		}
		...
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			return CreateView(Resource.Layout.installersearchview);
		...
		public new InstallerSearchViewModel ViewModel
		{
			get { return _viewModel ?? (_viewModel = base.ViewModel as InstallerSearchViewModel); }
		}
