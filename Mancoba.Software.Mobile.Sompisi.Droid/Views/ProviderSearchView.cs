...
namespace Mancoba.Sompisi.Droid.Views
{
	...
	[Register("mancoba.sompisi.droid.views.ProviderSearchView")]
	public class ProviderSearchView : MvxFragment
	{
		private ProviderSearchViewModel _viewModel;
		...
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			return CreateView(Resource.Layout.providersearchview);
		...
		public new ProviderSearchViewModel ViewModel
		{
			get { return _viewModel ?? (_viewModel = base.ViewModel as ProviderSearchViewModel); }
		}
